    ...
    <div id="wrapper">
        <header id="header" class="header">
                ...
                <div class="container">
                    <div class="row">
                        <div class="ml-auto col-md-8">
                            <ul class="d-flex flex-wrap list-unstyled justify-content-end align-items-center">
                                <li><a href="mailto:demonp@gmial.com"><i class="fa fa-envelope"></i>
                                        <span>demonp@gmial.com</span></a></li>
                                <li><a href="callto:9841110019"><i class="fa fa-phone"></i>
                                        <span>+977-9841110019</span></a></li>
                                <li>
            ...
            <div class="header-bottom-block">
                <div class="container">
                    <div class="header-bottom-wrapper d-flex justify-content-between">
                        <div class="header-logo">
                            <a href="#">
                                <img src="images/main-logo.png" alt="The Equity Pros" title="Sibhakamana Saccos">
                            </a>
                        </div>
                        <!--/.header_logo-->
                        <div class="header-navigation">
                            ...
                            <ul class="tab-item d-flex list-unstyled">
                                <li>
                                    <a href="#">Courses</a>
                                </li>
                                    ...
                                    <ul class="navbar-nav ml-auto list-unstyled d-flex justify-content-between">
                                        ...
                                        <li class="dropdown"><a href="#" class="dropdown-toggle" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Courses</a>
                                            <ul class="dropdown-menu">
                                                ...
                                                <li><a class="dropdown-item" href="#">Wrodpress</a></li>
                                            </ul>
                                        </li>
            ...
            <section class="intro-block top-btm-gutter5 text-center text-md-left">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-md-12 text-center intro-block-title mb-5">
                        ...
                        <div class="col-md-6 col-lg-5">
                            <iframe height="240px" src="https://www.youtube-nocookie.com/embed/b4Yx9eHfsuc" frameborder="0" allowfullscreen></iframe>
                        </div>
                    </div>
                </div>
            </section>
        ...
        <footer>
            <div class="footer-top">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-sm-6 col-lg-3 follow">
                            <figure>
                        ...
                        <div class="col-sm-6 col-lg-3 services">
                            ...
                            <ul class="list-unstyled">
                                <li>
                                    <a href="#">Web and Software Development Training</a>
                                </li>
                                <li>
                        ...
                        <div class="col-sm-6 col-lg-3 quick-links">
                            <h3>Quick Links</h3>
                            <ul class="list-unstyled">
                                <li>
            ...
            <div class="col-sm-12 message-pupop">
                <div class="text-right">
                    <div class="row">
                        <a class="round hollow" href="#" id="addClass"><span> <i class="fa fa-comments"></i> </span>
                        </a>
                    </div>
                </div>
                ...
                <div class="popup-box chat-popup" id="qnimate">
                    ...
                    <div class="popup-messages">
                        <div class="direct-chat-messages">
                            ...
                            <div class="direct-chat-msg doted-border">
                                ...
                                <!-- /.direct-chat-info -->
                                <img alt="message user image" src="images/raja.jpg" class="direct-chat-img">
                                <!-- /.direct-chat-img -->
                    ...
                    <div class="popup-messages-footer">
                        ...
                        <div class="btn-footer">
                            ...
                            <button class="bg_none"><i class="fa fa-thumbs-o-up"></i> </button>
                        </div>
                    </div>
                </div>
            </div><!-- col-sm-12 -->
