...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
                                ...
                                <div class="col-md-12">
                                    <div class="logo">
                                        <a class="navbar-brand page-scroll" href="#header">
                                            <h1><span class="r">r</span>w <span class="bl">rajwebdesign</span></h1>
                                        </a>
                                    </div>
                                                ...
                                                <div class="hex single">
                                                    <div class="hex single inner">
                                                        <div class="hex single inner2">
                                                            <a class="page-scroll" href="#services"><i class="fa fa-home"></i>
                                                                <p>Services</p>
                                                            </a>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="item hex4">
                                                <div class="item1">
                                                    <div class="hex single">
                                                        <div class="hex single inner">
                                                            <div class="hex single inner2">
                                                                <a class="page-scroll" href="#portfolio"><i class="fa fa-folder-open"></i>
                                                                    <p>Portfolio</p>
                                                                </a>
                                                            </div>
                                                        </div>
                                        ...
                                        <div class="line2">
                                            <div class="item hex5">
                                                <div class="hex single">
                                                    <div class="hex single inner">
                                                        <div class="hex single inner2">
                                                            <a class="page-scroll" href="#about"><i class="fa fa-info-circle"></i>
                                                                <p>About</p>
                                                            </a>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="item hex7">
                                                <div class="item1">
                                                    <div class="hex single">
                                                        <div class="hex single inner">
                                                            <div class="hex single inner2">
                                                                <a class="page-scroll" href="#contact"><i class="fa fa-mobile"></i>
                                                                    <p>Contact</p>
                                                                </a>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="item hex8">
                                                <div class="hex">
                                                    <div class="hex inner">
                                                        <div class="hex inner2">
                                                            <a href="#"><i class="fa fa-wordpress"></i>
                                                                <p>Wordpress</p>
                                                            </a>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="item hex9">
                                                <div class="item1">
                                                    <div class="hex single">
                                                        <div class="hex single inner">
                                                            <div class="hex single inner2">
                                                                <a class="page-scroll" href="#testimonials"><i class="fa  fa-comments"></i>
                                                                    <p>Testimonials</p>
                                                                </a>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-md-7 cap-input">
                                                    ...
                                                    <div class='short_explanation'>Can't read the image?
                                                        <a href='javascript: refresh_captcha_img();'>Refresh <i class="fa fa-refresh"></i></a>.
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
    ...
    <script type='text/javascript'>
        ...
        document.forms['contactus'].scaptcha.validator = new FG_CaptchaValidator(document.forms['contactus'].scaptcha,
    ...
    <script type="text/javascript">
        stLight.options({
            publisher: "d33da97a-9ba6-4f0b-8883-7107ca859f5d",
            doNotHash: false,
            doNotCopy: false,
